...
class TCPDF_STATIC {
     ...
     */
    protected static $curlopt_default = null;
     ...
     * @var array<int, bool|int|string> cURL options.
     */
    protected static $curlopt_fixed = null;
	...
	/**
	 * Initialize curl options conditionally.
	 * @private static
	 */
	private static function initCurlOptions() {
		if (self::$curlopt_default === null) {
			if (extension_loaded('curl')) {
				self::$curlopt_default = [
				...
				// Fallback values if curl is not available
				// Using numeric constants instead of named ones
				self::$curlopt_default = [
					78 => 5,      // CURLOPT_CONNECTTIMEOUT
					68 => 5,      // CURLOPT_MAXREDIRS
					181 => 15,    // CURLOPT_PROTOCOLS (HTTP | HTTPS | FTP | FTPS)
					81 => 2,      // CURLOPT_SSL_VERIFYHOST
					64 => true,   // CURLOPT_SSL_VERIFYPEER
					13 => 30,     // CURLOPT_TIMEOUT
					10018 => 'tcpdf',  // CURLOPT_USERAGENT
				];
				self::$curlopt_fixed = [
					45 => true,   // CURLOPT_FAILONERROR
					19 => true,   // CURLOPT_RETURNTRANSFER
				];
			}
		}
	}
	...
	/**
	 * Get the curl default options.
	 * @return array
	 * @private static
	 */
	private static function getCurloptDefault() {
		self::initCurlOptions();
		return self::$curlopt_default;
	}

	/**
	 * Get the curl fixed options.
	 * @return array
	 * @private static
	 */
	private static function getCurloptFixed() {
		self::initCurlOptions();
		return self::$curlopt_fixed;
	}
